...
// ** Router Components
import { Router as AppRouter, Route, Switch, Redirect, useHistory } from 'react-router-dom'
...
import routes from 'src/views/spinningWheel'
const Router = () => {
    ...
    <AppRouter history={history} >
      <Switch>
        ...
        <Route
                ...
                render={() => {
                    return (
                      <Redirect to="/spinningWheel/list" />
                    )
                }}
              />
        {routes?.map(r=>
